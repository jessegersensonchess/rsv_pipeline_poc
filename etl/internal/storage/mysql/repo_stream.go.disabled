// Package mysql contains streaming/batched loading utilities for MySQL.
// Identical behavior to the other adapters, parameterized by CopyFn.
package mysql
...
// CopyFn abstracts the batch insert operation.
...
// and invokes 'copyFn' for each non-empty batch. It returns the total rows and
